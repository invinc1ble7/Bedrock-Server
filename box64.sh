...
proot-distro login ubuntu-lts -- wget -qO- https://ryanfortner.github.io/box64-debs/KEY.gpg | proot-distro login ubuntu-lts -- gpg --dearmor -o /etc/apt/trusted.gpg.d/box64-debs-archive-keyring.gpg
